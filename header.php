...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="443" height="100" align="center" bgcolor="#182E43"><a href="http://www.phpaa.cn" target="_blank"><img src="images/logo.gif" width="396" height="78" border="0" /></a></td>
    <td align="right" valign="top" bgcolor="#182E43" class="white" style="padding-top:5px">
    <a href="http://www.phpaa.cn" onClick="this.style.behavior='url(#default#homepage)';this.setHomePage('http://www.phpaa.cn/');return(false);" style="behavior: url(#default#homepage)" class="white">设为首页 </a>｜ 
    <a href="javascript:window.external.addFavorite('http://www.phpaa.cn/','文章管理系统');" class="white">加入收藏 </a>｜ 
